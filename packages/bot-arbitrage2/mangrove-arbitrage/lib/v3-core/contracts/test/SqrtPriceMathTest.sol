...
contract SqrtPriceMathTest {
  function getNextSqrtPriceFromInput(uint160 sqrtP, uint128 liquidity, uint amountIn, bool zeroForOne)
    external
    pure
  ...
  function getGasCostOfGetNextSqrtPriceFromInput(uint160 sqrtP, uint128 liquidity, uint amountIn, bool zeroForOne)
    external
    view
    returns (uint)
  {
  ...
  function getNextSqrtPriceFromOutput(uint160 sqrtP, uint128 liquidity, uint amountOut, bool zeroForOne)
    external
    pure
    returns (uint160 sqrtQ)
  {
  ...
  function getGasCostOfGetNextSqrtPriceFromOutput(uint160 sqrtP, uint128 liquidity, uint amountOut, bool zeroForOne)
    external
    view
    returns (uint)
  {
