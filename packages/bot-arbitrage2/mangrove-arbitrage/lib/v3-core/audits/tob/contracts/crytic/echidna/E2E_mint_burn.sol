...
contract E2E_mint_burn {
  ...
  //
  //
  function _getRandomPositionIdx(uint128 _seed, uint _positionsCount) internal view returns (uint128 positionIdx) {
  ...
  function removePosition(uint _posIdx) internal {
