...
contract Other {
  // prop #30
  function test_getNextSqrtPriceFromInAndOutput(uint160 sqrtPX96, uint128 liquidity, uint amount, bool add) public {
    ...
    uint next_sqrt = SqrtPriceMath.getNextSqrtPriceFromInput(sqrtPX96, liquidity, amount, add);
