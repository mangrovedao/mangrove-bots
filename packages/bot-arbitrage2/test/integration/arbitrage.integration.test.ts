/**
 * Integration tests of arbitrage bot.
 */
...
describe("ArbBot integration tests", () => {
  ...
  describe("test arb bot", () => {
    it.only(`should find arb and do arb, ask`, async function () {
      ...
      // );
      //
      // const txActivate = await activateTokens(mgv, [market.base, market.quote], arbitragerContract);
      // await mgvTestUtil.waitForBlock(mgvDeployer, txActivate.blockNumber);
      //
      // const txActivatePool = await activatePool(arbitragerContract, poolInfo.poolContract.address);
      //
      // if (txActivatePool) {
      ...
      //   },
      // });
      // const profitableArbs = await checkProfitableArbitrage(mgvDeployer, arbitragerContract, [
      //   {
      //     base: market.base,
      //     quote: market.quote,
      //     tickSpacing: "1",
