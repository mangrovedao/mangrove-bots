...
contract MgvArbitrageForTest is AccessControlled {
  ...
  /// @param _arbitrager The address of the arbitrager
  /// @param uniV3Router The address of the Uniswap V3 router
  constructor(IMangrove _mgv, address admin, address _arbitrager, address uniV3Router) AccessControlled(admin) {
    mgv = _mgv;
    arbitrager = _arbitrager;
    router = ISwapRouter(uniV3Router);
  }
